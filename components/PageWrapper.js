...
import {Link} from 'react-router-dom';//The primary way to allow users to navigate around your application. <Link> will render a fully accessible anchor tag with the proper href.

class PageWrapper extends Component {
//Wrappers are a way to provide a header and footer to content within your framework
    render(){
